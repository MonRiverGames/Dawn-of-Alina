...
public class PlayerInteractZach : MonoBehaviour
{
    private Camera cam;
    [SerializeField]
    ...
    private InputManagerZach inputManager;
    
    // Start is called before the first frame update
    void Start()
    {
        cam = GetComponent<PlayerLookZach>().cam;
        playerUI = GetComponent<PlayerUI>();
        inputManager = GetComponent<InputManagerZach>();
    }
